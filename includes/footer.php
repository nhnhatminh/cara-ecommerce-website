<footer class="section-p1">
    ...
    <script>
        // --- LOGIC KIỂM TRA ĐĂNG NHẬP (MOCKUP LOCALSTORAGE) ---
        // Script này sẽ chạy ở mọi trang để cập nhật Header
        ...
        if (currentUser) {
            ...
            // Nếu đã đăng nhập: Thay nút "Đăng Nhập" bằng Tên + nút Logout
            if(authBtn) {
        ...
        // Hàm chặn truy cập các trang cần đăng nhập (dùng cho thẻ <a>)
