...
// Tính tổng tiền (Backend verification)
$total_money = 0;
...
if (isset($_POST['btn_order'])) {
  ...
  try {
    ...
    $order_id = $pdo->lastInsertId(); // Lấy ID vừa tạo
    ...
    <div class="checkout-grid">
      ...
      <div class="checkout-left">
        ...
        <div class="checkout-step">
          ...
          <div class="form-group">
            <label>Địa chỉ</label>
            <textarea name="address" rows="3" required placeholder="Số nhà, đường, phường/xã..."></textarea>
          </div>
        </div>

        <div class="checkout-step">
          <h4 class="step-title" style="margin-top: 20px;">2. Hình thức thanh toán</h4>
        ...
        <div id="checkout-list" style="margin: 20px 0; border-bottom: 1px solid #ddd; padding-bottom: 10px;">
          <?php foreach($cart as $item): ?>
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px; font-size: 14px;">
              <span>
                <b><?php echo $item['quantity']; ?>x</b> <?php echo htmlspecialchars($item['name']); ?>
                <br>
                <small style="color:#888;">Size: <?php echo $item['size']; ?></small>
              </span>
