...
// 1. CẤU HÌNH TRANG
$page = 'cart';
$extraCss = 'assets/css/cart.css?v=' . time(); // Dùng time() thay rand() để cache mới nhất
      ...
      <?php else: ?>
        <tr>
          <td colspan="6" style="text-align: center; padding: 30px;">
            ...
            <a href="shop.php" style="color: var(--primary-color); text-decoration: underline;">Quay lại cửa hàng</a>
          </td>
        </tr>
      <?php endif; ?>
    </tbody>
