...
$page = 'shop';
$extraCss = 'assets/css/shop.css'; // Header sẽ tự động load file này vào thẻ <head>
...
try {
    // A. Đếm tổng số sản phẩm để tính tổng số trang
    ...
    // Lưu ý: PDO LIMIT/OFFSET cần bind dạng INT
...
<section id="pagination" class="section-p1">
    ...
    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
        <a href="?page=<?php echo $i; ?>" class="<?php echo ($i == $page_curr) ? 'active' : ''; ?>" 
...
<script>
    // Hàm thêm nhanh vào giỏ (Chuyển hướng sang chi tiết để chọn size)
