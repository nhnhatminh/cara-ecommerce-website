...
// 1. CẤU HÌNH TRANG
$page = 'about'; // Active menu "Giới thiệu"
$extraCss = 'assets/css/about.css'; // Load CSS riêng
...
<section id="newsletter" class="section-p1 section-m1">
  <div class="newstext">
    ...
    <p>Nhận thông tin cập nhật mới nhất về cửa hàng và <span>ưu đãi đặc biệt qua Email.</span></p>
  </div>
  <div class="form">
