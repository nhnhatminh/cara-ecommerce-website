...
// Kiểm tra quyền Admin (Sử dụng session key mới)
...
<div class="main-content">
  ...
  <div id="dashboard" class="section-content active">
    <div class="cards">
      ...
      <div class="card-single">
        <div class="card-info">
          <h1 id="total-products-count">0</h1>
          <span>Sản Phẩm</span>
        </div>
  ...
  <div id="products" class="section-content">
    <div class="card-table">
      <div class="card-header">
        ...
        <button class="btn-action" onclick="openProductModal()">
  ...
  <div id="orders" class="section-content">
    <div class="card-table">
      ...
      <table>
        <thead>
          <tr><th>Ngày</th><th>Khách</th><th>SĐT</th><th>Tiền</th><th>Trạng Thái</th><th>Hành Động</th></tr>
        </thead>
  ...
  <div id="customers" class="section-content">
    <div class="card-table">
      ...
      <table>
        <thead>
          <tr><th>Họ Tên</th><th>Email</th><th>SĐT</th><th>Địa Chỉ</th><th>Hành Động</th></tr>
        </thead>
  ...
  <div id="reviews" class="section-content"><h3>Đang phát triển...</h3></div>
</div>
